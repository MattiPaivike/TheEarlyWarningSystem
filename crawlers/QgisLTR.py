...
def crawl_version(data):
    ...
    versions_list = [ x.replace(" LTR", "") for x in versions_list ]
...
def crawl_dllink_x86(version, data):
    ...
    #get first link witch we expect to be 64bit latest LTR release Version
    dllink_32 = links_list[1]
