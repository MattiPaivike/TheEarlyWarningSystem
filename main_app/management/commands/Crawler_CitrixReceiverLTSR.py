...
class Command(BaseCommand):
    help = 'web crawler for Citrix Receiver LTSR'

    def handle(self, *args, **options):
        Error_var = False
        errors = []
        initial_version = False
        appname = "Citrix Receiver (LTSR)"
        ...
        #define our main url
        url = "https://www.citrix.fi/downloads/citrix-receiver/windows-ltsr/receiver-for-windows-ltsr-latest.html"
        downloadURL = url
        ...
        if Error_var != True:
            ...
            divs = page_soup.findAll("div", {"class": "ctx-text-content"})
            for div in divs:
                h1 = div.find("h1")
