...
class Command(BaseCommand):
    help = 'web crawler for Adobe Acrobat Reader 2015'

    def handle(self, *args, **options):
        Error_var = False
        errors = []
        initial_version = False
        appname = "Adobe Acrobat Reader 2015"
        #logging
        ...
        downloadURL = "https://helpx.adobe.com/acrobat/release-note/release-notes-acrobat-reader.html"
        ...
        if Error_var != True:
            ...
            #select first index of found tables and search for the pattern
            ver = repElemList[2]
            versions_list = re.findall(r, str(ver))
