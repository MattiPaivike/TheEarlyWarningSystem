...
class Command(BaseCommand):
    help = 'web crawler for Citrix Receiver'
    ...
    def handle(self, *args, **options):
        ...
        #define our main url
        url = "https://www.citrix.com/downloads/citrix-receiver/windows/"
        downloadURL = url
        ...
        if Error_var != True:
            ...
            try:
                versions = [ verparse.LegacyVersion(str(x)) for x in versions_list ]
            except:
