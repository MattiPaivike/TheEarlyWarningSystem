...
#this is used to run only a single web crawler
...
def custom_log(message):
    ...
    #define logfilename
    logfilename = "main_runner_single_app.log"
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('crawler_name', type=str, help='crawler name', nargs='?', default="")

    def handle(self, *args, **kwargs):
        crawler_name = kwargs['crawler_name']

        #logging settings
        custom_log('Starting singlerunner task for app: ' + crawler_name)
